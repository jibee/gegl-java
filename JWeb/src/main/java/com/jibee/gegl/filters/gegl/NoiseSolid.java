...
*/
public class NoiseSolid extends GeglFilter
{
...
Acceptable Range:  
*/
    private boolean m_Tilable  = false;
...
Acceptable Range:  
*/
    public NoiseSolid setTilable(boolean value)
    {
	
        m_Tilable = value;
        setProperty("tilable", value);
        return this;
    }
