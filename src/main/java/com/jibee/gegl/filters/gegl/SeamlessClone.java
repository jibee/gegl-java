 ...
 */
@GeglFilterOp(license="GPL3+", opencl=false, position_dependant=false, categories={"blend"})
public class SeamlessClone extends GeglFilter implements CombiningFilter
{
    /** Constructs a .
     *
     * Seamless cloning operation
    ...
    @Override
    public InputPad<SeamlessClone> Aux()
    {
        return new InputPad<>(this, "aux");
    }

    @Override
    public InputPad<SeamlessClone> Input()
    {
        return new InputPad<>(this, "input");
    }
    @Override
    public OutputPad<SeamlessClone> Output()
    {
