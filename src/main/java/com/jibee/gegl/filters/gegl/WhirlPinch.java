 ...
 */
@GeglFilterOp(license="GPL3+", opencl=false, position_dependant=true, categories={"distort", "map"})
public class WhirlPinch extends GeglFilter implements Filter
{
    ...
    @Override
    public InputPad<WhirlPinch> Input()
    {
        return new InputPad<>(this, "input");
    }
    @Override
    public OutputPad<WhirlPinch> Output()
    {
